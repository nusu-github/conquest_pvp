...
## 拠点状態表示
title @a[team=red,x=96,y=123,z=24,dx=8,dy=20,dz=-8] actionbar [{"text":"占領状態:"},{"score":{"name":"@e[tag=northeast]","objective":"red"}},{"text":"/250"}]
title @a[team=red,x=144,y=123,z=24,dx=-8,dy=20,dz=-8] actionbar [{"text":"占領状態:"},{"score":{"name":"@e[tag=northwest]","objective":"red"}},{"text":"/250"}]
title @a[team=red,x=96,y=123,z=-24,dx=8,dy=20,dz=8] actionbar [{"text":"占領状態:"},{"score":{"name":"@e[tag=southeast]","objective":"red"}},{"text":"/250"}]
title @a[team=red,x=144,y=123,z=-24,dx=-8,dy=20,dz=8] actionbar [{"text":"占領状態:"},{"score":{"name":"@e[tag=southwest]","objective":"red"}},{"text":"/250"}]
## 北東
