...
execute as @a[scores={used_crossbow=4..}] run scoreboard players set @s used_crossbow 0
execute as @a[scores={used_crossbow=4..}] run scoreboard players set @s recharge 1