...
title @s actionbar [{"text":"残り:"},{"score":{"name":"@s","objective":"seconds"}},{"text":"/3"}]
...
execute if score @s seconds matches 3.. run function conquest_pvp:conquest/job/attacker
execute if score @s seconds matches 3.. run replaceitem entity @s hotbar.1 air 1
execute if score @s seconds matches 3.. run scoreboard players set @s used_stick 0
execute if score @s seconds matches 3.. run scoreboard players set @s seconds 0
