...
clear @s
## インフィニティ・ボウ
replaceitem entity @s hotbar.0 bow{display:{Name:'{"text":"インフィニティ・ボウ"}',Lore:['{"text":"なんかすごい弓"}','{"text":"持っている間は防御力が下がるので注意"}']},Unbreakable:1b,Enchantments:[{id:"minecraft:power",lvl:1s},{id:"minecraft:punch",lvl:2s},{id:"minecraft:infinity",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:-0.25,Operation:1,UUIDLeast:2150571,UUIDMost:9497484},{AttributeName:"generic.movementSpeed",Name:"generic.movementSpeed",Amount:-0.1,Operation:1,UUIDLeast:8860326,UUIDMost:-2803274}]} 1
## 無適用の矢
replaceitem entity @s weapon.offhand arrow 1
## 固定スキル 爆破
