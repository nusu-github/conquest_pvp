...
# アタッカー
execute as @s[scores={attacker=1}] run title @s actionbar [{"text":"スキルリチャージ中:"},{"score":{"name":"@s","objective":"seconds"}},{"text":"/40"}]
execute as @s[scores={attacker=1}] if score @s seconds matches 40.. run function conquest_pvp:conquest/re_setup
# タンク
