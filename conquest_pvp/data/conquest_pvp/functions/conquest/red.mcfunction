...
execute as @s at @s if score @s red matches 250.. run summon minecraft:area_effect_cloud ~ ~ ~ {CustomNameVisible:0b,Duration:32768,Tags:["decision_red"],CustomName:'{"text":"判定"}'}
